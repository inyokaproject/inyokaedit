...
<@ elseif ($key as stripped) as lowercase matches_regex '^f([1-9]|1[0-2])$' @><@ ($key as stripped) as uppercase @>
...
<@ elseif ['win','windows','super'] contains ($key as stripped) as lowercase @>Windows
<@ elseif ['tux'] contains ($key as stripped) as lowercase @>Tux
<@ elseif ['any'] contains ($key as stripped) as lowercase @>ANY KEY
...
<@ elseif ['⎄', 'compose'] contains ($key as stripped) as lowercase @>compose
