...
<@ if ['general', 'artful', 'zesty', 'xenial', 'trusty' ] contains ($arguments.0 as lowercase) or ($arguments.1 as lowercase) or ($arguments.2 as lowercase) or ($arguments.3 as lowercase)@> 
<@ if $arguments as lowercase contain 'general' @>
Dieser Artikel ist größtenteils für alle Ubuntu-Versionen gültig.
<@ else @><@ if $arguments as lowercase contain 'artful' @>
  * [:Artful_Aardvark:Ubuntu 17.10] Artful Aardvark
<@ endif @><@ if $arguments as lowercase contain 'zesty' @>
...
<@ endif @>
|}}
<@ if ['general', 'artful', 'zesty', 'xenial', 'trusty', 'precise'] contains ($arguments.0 as lowercase) or ($arguments.1 as lowercase) or ($arguments.2 as lowercase) or ($arguments.3 as lowercase)@> 
<@ if $arguments as lowercase contain 'general' @>
#getestet: general
<@ else @>
