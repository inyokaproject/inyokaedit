;InyokaEdit NSIS installer script

  !define APPNAME "InyokaEdit"
  !define DESCRIPTION "A markup editor for Inyoka articles"
  !define VERSIONMAJOR 0
  !define VERSIONMINOR 26
  ...
  !define MUI_ICON "inyokaedit.ico"
...
Section
  ...
  ;Add all files from folder InyokaEdit into installer
  File /r ${APPNAME}\*.*
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuFolder\${APPNAME}.lnk" "$INSTDIR\InyokaEdit.exe"
